 ...
 * React Component
 */
export interface NewJoinersWidgetProps extends BlockAttributes {
...
export const NewJoinersWidget = ({ dateformat, anniversaryprofilefieldid, includepending, numbertoshow, loadingmessage, noinstancesmessage, title, todaytitle, yearword, yearwordplural, showdate, showwholemonth, groupid, showwholemonthforxdays, imageurl, showdaysbefore, showdaysafter, splitbyyear, specialyears, hideyearheader, linktochat, limit, headercolor, additionalfieldsdisplayed, optoutgroupid, includeyear, daysbeforetitle, daysaftertitle, networkid, fieldfilter, fieldvalue, optoutfield, optoutvalue }: NewJoinersWidgetProps): ReactElement => {
