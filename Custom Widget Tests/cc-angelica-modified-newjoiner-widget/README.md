...
The New Joiners Widget will display users that just started working based on the settings.

The start dates for each user need to exist in a Custom Profile Field. 